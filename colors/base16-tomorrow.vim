...
"       execute "silent !/bin/sh
"       ".g:base16_shell_path."/base16-tomorrow.".&background.".sh"
"         endif
"         endif
"
...
"                                 fun <sid>hi(group, guifg, guibg, ctermfg,
"                                 ctermbg, attr)
"                                   if a:guifg != ""
                            ...
                            if a:ctermbg != ""
                                  exec "hi " . a:group . " ctermbg=" . s:cterm(a:ctermbg)
                                      ...
                                      if a:attr != ""
                                            ...
                                            " Return GUI color for light/dark
                                            " variants
                                            " fun s:gui(color)
                                            "   if &background == "dark"
                                            "       return a:color
                                            ...
                                            " " Diff highlighting
                                            " call <sid>hi("DiffAdd",
                                            " s:gui0B, s:gui01,  s:cterm0B,
                                            " s:cterm01, "")
                                            " call <sid>hi("DiffChange",
                                            " s:gui03, s:gui01,  s:cterm03,
                                            " s:cterm01, "")
                                            " call <sid>hi("DiffDelete",
                                            " s:gui08, s:gui01,  s:cterm08,
                                            " s:cterm01, "")
                                            " call <sid>hi("DiffText",
                                            " s:gui0D, s:gui01,  s:cterm0D,
                                            " s:cterm01, "")
                                            " call <sid>hi("DiffAdded",
                                            " s:gui0B, s:gui00,  s:cterm0B,
                                            " s:cterm00, "")
                                            " call <sid>hi("DiffFile",
                                            " s:gui08, s:gui00,  s:cterm08,
                                            " s:cterm00, "")
                                            " call <sid>hi("DiffNewFile",
                                            " s:gui0B, s:gui00,  s:cterm0B,
                                            " s:cterm00, "")
                                            " call <sid>hi("DiffLine",
                                            " s:gui0D, s:gui00,  s:cterm0D,
                                            " s:cterm00, "")
                                            ...
                                            " " Git highlighting
                                            " call
                                            " <sid>hi("gitCommitOverflow",
                                            " s:gui08, "", s:cterm08, "", "")
                                            " call <sid>hi("gitCommitSummary",
                                            " s:gui0B, "", s:cterm0B, "", "")
                                            "   
                                            "   " GitGutter highlighting
                                            "   call <sid>hi("GitGutterAdd",
                                            "   s:gui0B, s:gui01, s:cterm0B,
                                            "   s:cterm01, "")
                                            ...
                                            " s:gui05, s:gui00, s:cterm05,
                                            " s:cterm00, "")
                                            " call
                                            " <sid>hi("markdownCodeBlock",
                                            " s:gui0B, "", s:cterm0B, "", "")
                                            " call
                                            " <sid>hi("markdownHeadingDelimiter",
                                            " s:gui0D, "", s:cterm0D, "", "")
                                            "
                                            " " NERDTree highlighting
                                            " call <sid>hi("NERDTreeDirSlash",
                                            " s:gui0D, "", s:cterm0D, "", "")
                                            " call <sid>hi("NERDTreeExecFile",
                                            " s:gui05, "", s:cterm05, "", "")
                                            "
                                            " " PHP highlighting
                                            " call
                                            ...
                                            " s:gui05, "", s:cterm05, "", "")
                                            " call <sid>hi("phpComparison",
                                            " s:gui05, "", s:cterm05, "", "")
                                            " call <sid>hi("phpParent",
                                            " s:gui05, "", s:cterm05, "", "")
                                            "
                                            " " Python highlighting
                                            ...
                                            " s:gui0A, "", s:cterm0A, "", "")
                                            " call
                                            " <sid>hi("rubyInterpolation",
                                            " s:gui0B, "", s:cterm0B, "", "")
                                            " call
                                            " <sid>hi("rubyInterpolationDelimiter",
                                            " s:gui0F, "", s:cterm0F, "", "")
                                            ...
                                            " call <sid>hi("SignifySignAdd",
                                            " s:gui0B, s:gui01, s:cterm0B,
                                            " s:cterm01, "")
                                            " call
                                            " <sid>hi("SignifySignChange",
                                            " s:gui0D, s:gui01, s:cterm0D,
                                            " s:cterm01, "")
                                            " call
                                            " <sid>hi("SignifySignDelete",
                                            " s:gui08, s:gui01, s:cterm08,
                                            " s:cterm01, "")
                                            "
                                            ...
                                            " unlet s:gui00 s:gui01 s:gui02
                                            " s:gui03  s:gui04  s:gui05
                                            " s:gui06  s:gui07  s:gui08
                                            " s:gui09 s:gui0A  s:gui0B
                                            " s:gui0C  s:gui0D  s:gui0E
                                            " s:gui0F
                                            " unlet s:cterm00 s:cterm01
                                            " s:cterm02 s:cterm03 s:cterm04
                                            " s:cterm05 s:cterm06 s:cterm07
                                            " s:cterm08 s:cterm09 s:cterm0A
                                            " s:cterm0B s:cterm0C s:cterm0D
                                            " s:cterm0E s:cterm0F
