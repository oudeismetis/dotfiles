...
alias sydb="dropdb serviceyear && createdb serviceyear && pg_restore -d serviceyear \"../staging-env/staging.dump\"; syfor python manage.py migrate && syfor python manage.py clearbuildcache && syfor python manage.py build_index"
